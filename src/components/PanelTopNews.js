...
const PanelTopNews = ({ dispatch }) =>{    
   let  selectLanguage, selectCategory,inputKeyword, selectCountry;
   return (
    <div class="w3-card w3-round w3-white">
      <div class="w3-container">
        <h4 class="w3-center">Search Top News</h4>
        <hr></hr>
...
export default connect(getTopNews)(PanelTopNews)